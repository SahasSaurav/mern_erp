...
const Profile = () => {
  ...
  return (
    <AppShell>
      <div className="h-full w-full rounded-3xl bg-white dark:bg-blueGray-800 py-4 px-8">

        <h2 className="text-3xl  dark:text-gray-50 mb-8 ">Edit profile</h2>
          ...
          <form onSubmit={handleSubmit(onSubmitHandler)} className="w-full ">
            ...
            <button
              className={` ${loading ? "bg-blue-300" : "bg-blue-500"} ${loading ? "bg-blue-300" : "hover:bg-blue-600"
                } text-white  font-semibold uppercase text-base px-8 py-3 rounded-lg shadow-xs hover:shadow-lg outline-none focus:outline-none mr-1 mt-2 mb-2 transition duration-100`}
              type="submit"
              disabled={loading}
            >
